...
const LXModal: React.FC<ModalProps> = ({ title, open, onOk, onCancel, children }) => {
    if (!open) return null;
    return (
        <div className="fixed inset-0 z-1000 overflow-auto outline-0 bg-black/45 h-auto m-0 p-0">
            <div className="relative top-25 mx-auto bg-white py-5 px-6 rounded-xl shadow-lg w-lg origin-[459px_269px] z-1001 ">
