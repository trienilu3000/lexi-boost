...
const Home = () => {
    return (
        <div className="relative p-6 flex flex-col items-center bg-gray-100 min-h-screen">
            <div className="absolute top-4 right-4 bg-orange-500 text-white px-4 py-2 rounded-lg shadow-md">
                🔥 Streak: 5 Days
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center w-full max-w-3xl">
                ...
                <p className="text-sm text-gray-500 mt-2 min-h-[20px]">6/10 words learned</p>
            </div>
            <div className="flex flex-wrap justify-center gap-6 mt-6 w-full max-w-6xl">
                <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition flex-1 min-w-[250px] max-w-sm">
                    <h3 className="text-lg font-semibold text-gray-700">Learn Vocabulary</h3>
                    <p className="text-sm text-gray-500 mt-2 min-h-[40px]">Memorize new words with flashcards and quizzes.</p>
                    <Link to="/vocabulary">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition flex-1 min-w-[250px] max-w-sm">
                    <h3 className="text-lg font-semibold text-gray-700">Practice Listening</h3>
                    <p className="text-sm text-gray-500 mt-2 min-h-[40px]">Listen to conversations and fill in missing words.</p>
                    <Link to="/listening">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition flex-1 min-w-[250px] max-w-sm">
                    <h3 className="text-lg font-semibold text-gray-700">Improve Reading</h3>
                    <p className="text-sm text-gray-500 mt-2 min-h-[40px]">Read articles and short stories to build comprehension.</p>
                    <Link to="/reading">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition flex-1 min-w-[250px] max-w-sm">
                    ...
                    <p className="text-sm text-gray-500 mt-2 min-h-[40px]">Keep your learning streak alive!</p>
                    <Link to="/grammar">
